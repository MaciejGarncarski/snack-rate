      ...
      {isEmpty ? (
        ...
        <>
          <motion.button
            type="button"
            className={cn(
              "outline-none flex aspect-4/5 h-auto bg-gradient-transparency w-full items-center justify-center overflow-hidden rounded-lg border border-dashed border-accent  outline-0 focus:border-solid focus:ring focus:ring-ring",
